...
CSS = """
:root{--paper:#F6F4EF;--surface:#FFFFFF;--line:#DAD6CC;--ink:#1B1F24;--ink2:#4A5058;--ink3:#7A8088;
--navy:#1F3A5F;--signal:#A33A2B;--sage:#5E7F68;--tint:#E8EDF3}
...
h1,h2{font-family:'Source Serif 4',Georgia,serif;font-weight:600;line-height:1.25}
...
th{background:var(--paper);font-weight:600;position:sticky;top:0}
